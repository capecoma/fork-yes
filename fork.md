---
allowed-tools: Bash(grep:*,basename:*,pwd:*,sed:*,echo:*,wt:*,ls:*)
description: Fork current conversation into new terminal tab
---

# Fork Conversation

Fork the current Claude Code session into a new Windows Terminal tab, preserving full conversation context. Works reliably even with multiple sessions open in the same project.
